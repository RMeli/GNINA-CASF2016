...
rm(list=ls());
require(boot);
data_all<-read.table("analysis/outputs/scoring/amberopt/dense_Affinity_processed_score",header=FALSE);
...
sink("analysis/outputs/scoring/amberopt/dense_Affinity-ci.results");
