...
rm(list=ls());
require(boot);
data_all<-read.table("analysis/outputs/scoring/noopt/general_default2018_CNNscore_processed_score",header=FALSE);
...
sink("analysis/outputs/scoring/noopt/general_default2018_CNNscore-ci.results");
