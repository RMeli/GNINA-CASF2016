...
rm(list=ls());
require(boot);
data_all<-read.table("analysis/outputs/scoring/vinaopt/dense_CNNscore_processed_score",header=FALSE);
...
sink("analysis/outputs/scoring/vinaopt/dense_CNNscore-ci.results");
