...
rm(list=ls());
require(boot);
data_all<-read.table("analysis/outputs/scoring/vinaopt/dense_Affinity_processed_score",header=FALSE);
...
sink("analysis/outputs/scoring/vinaopt/dense_Affinity-ci.results");
